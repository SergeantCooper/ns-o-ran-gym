...
def main():
    ...
    ap.add_argument("--timesteps", type=int, default=100000, help="upper bound; the time limit usually binds")
    ap.add_argument("--max_hours", type=float, default=3.5, help="wall-clock training cap (0 = no cap)")
